class ThreadingSingle {
  ...
  get instructions() {
    ...
    const lines = [];
    lines.push("Generated by https://piellardj.github.io/image-stylization-threading.");
    lines.push("Here are instructions to reproduce this in real life. Use highest quality and opacity for best results.");
    lines.push("Space units below are abstract — scale them to your needs (e.g. 1 unit = 1 mm).");
  ...
  resetHiddenCanvas() {
    ...
    this.hiddenCanvasContext.drawImage(this.sourceImage, 0, 0, size.width, size.height);
